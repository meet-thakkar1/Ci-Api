...
using CI_Application.Models.Models;

namespace CI_Application.Models.Data
{
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=PCT42\\SQLSERVER2019;DataBase=Ciplatform;User ID=sa;Password=Tatva@123;TrustServerCertificate=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ContactU>(entity =>
            {
                entity.HasKey(e => e.ContactusId)
                    .HasName("PK__contact___226C467933187C44");
                ...
                entity.HasOne(d => d.User)
                    ...
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__contact_u__user___2EA5EC27");
            });
            ...
            modelBuilder.Entity<FavouriteMission>(entity =>
            {
                ...
                entity.HasOne(d => d.Mission)
                    ...
                    .HasForeignKey(d => d.MissionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__favourite__missi__01142BA1");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.FavouriteMissions)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__favourite__user___00200768");
            });
            ...
            modelBuilder.Entity<Mission>(entity =>
            {
                ...
                entity.HasOne(d => d.City)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission__city_id__628FA481");

                entity.HasOne(d => d.Country)
                    .WithMany(p => p.Missions)
                    .HasForeignKey(d => d.CountryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission__country__619B8048");

                entity.HasOne(d => d.Theme)
                    .WithMany(p => p.Missions)
                    .HasForeignKey(d => d.ThemeId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission__theme_i__60A75C0F");
            });
            ...
            modelBuilder.Entity<MissionDocument>(entity =>
            {
                ...
                entity.HasOne(d => d.Mission)
                    ...
                    .HasForeignKey(d => d.MissionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission_d__missi__151B244E");
            });
            ...
            modelBuilder.Entity<MissionInvite>(entity =>
            {
                ...
                entity.HasOne(d => d.FromUser)
                    ...
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission_i__from___1BC821DD");

                entity.HasOne(d => d.Mission)
                    .WithMany(p => p.MissionInvites)
                    .HasForeignKey(d => d.MissionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission_i__missi__1AD3FDA4");

                entity.HasOne(d => d.ToUser)
                    .WithMany(p => p.MissionInviteToUsers)
                    .HasForeignKey(d => d.ToUserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission_i__to_us__1CBC4616");
            });

            modelBuilder.Entity<MissionMedium>(entity =>
            {
                entity.HasKey(e => e.MissionMediaId)
                    .HasName("PK__mission___848A78E81530D729");
                ...
                entity.HasOne(d => d.Mission)
                    ...
                    .HasForeignKey(d => d.MissionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission_m__missi__22751F6C");
            });
            ...
            modelBuilder.Entity<MissionRating>(entity =>
            {
                ...
                entity.HasOne(d => d.Mission)
                    ...
                    .HasForeignKey(d => d.MissionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission_r__missi__2B0A656D");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.MissionRatings)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__mission_r__user___2A164134");
            });
            ...
            modelBuilder.Entity<PasswordReset>(entity =>
            {
                entity.HasKey(e => e.Token)
                    .HasName("PK__password__CA90DA7BE294E8E8");
            ...
            modelBuilder.Entity<Story>(entity =>
            {
                ...
                entity.HasOne(d => d.Mission)
                    ...
                    .HasForeignKey(d => d.MissionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__story__mission_i__40F9A68C");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Stories)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__story__user_id__40058253");
            });
            ...
            modelBuilder.Entity<StoryInvite>(entity =>
            {
                ...
                entity.HasOne(d => d.FromUser)
                    ...
                    .HasForeignKey(d => d.FromUserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__story_inv__from___4B7734FF");

                entity.HasOne(d => d.Story)
                    .WithMany(p => p.StoryInvites)
                    .HasForeignKey(d => d.StoryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__story_inv__story__4A8310C6");

                entity.HasOne(d => d.ToUser)
                    .WithMany(p => p.StoryInviteToUsers)
                    .HasForeignKey(d => d.ToUserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__story_inv__to_us__4C6B5938");
            });

            modelBuilder.Entity<StoryMedium>(entity =>
            {
                entity.HasKey(e => e.StoryMediaId)
                    .HasName("PK__story_me__29BD053CCA032E2A");
                ...
                entity.HasOne(d => d.Story)
                    ...
                    .HasForeignKey(d => d.StoryId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__story_med__story__5224328E");
            });
            ...
            modelBuilder.Entity<Timesheet>(entity =>
            {
                ...
                entity.HasOne(d => d.Mission)
                    ...
                    .HasForeignKey(d => d.MissionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__timesheet__missi__58D1301D");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.Timesheets)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__timesheet__user___57DD0BE4");
            });
            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasOne(d => d.City)
                    .WithMany(p => p.Users)
                    .HasForeignKey(d => d.CityId)
                    .HasConstraintName("FK__user__city_id__5165187F");

                entity.HasOne(d => d.Country)
                    .WithMany(p => p.Users)
                    .HasForeignKey(d => d.CountryId)
                    .HasConstraintName("FK__user__country_id__52593CB8");
            });
            ...
            modelBuilder.Entity<UserSkill>(entity =>
            {
                ...
                entity.HasOne(d => d.Skill)
                    ...
                    .HasForeignKey(d => d.SkillId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__user_skil__skill__6166761E");

                entity.HasOne(d => d.User)
                    .WithMany(p => p.UserSkills)
                    .HasForeignKey(d => d.UserId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__user_skil__user___607251E5");
            });
